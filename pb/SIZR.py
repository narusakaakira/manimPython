...
class SIZREquationsToFlowchartFull(Scene):
    def construct(self):
        ...
        eq3 = MathTex("Z'", "=", r"\rho I", "+", r"\zeta R", "-", r"\alpha S Z", font_size=font_size)
        ...
        s_to_r_above = VGroup(
            ...
            Arrow(R_box.get_top() + UP*1.2, R_box.get_top(), stroke_width=2)
        )
        s_to_r_above_label = MathTex(r"\delta S").move_to(S_box.get_top() + R_box.get_top() + UP*1.2).shift(UP*0.3)
        ...
        i_to_r_below = VGroup(
            ...
            Arrow(R_box.get_bottom() + DOWN*1.2, R_box.get_bottom(), stroke_width=2)
        )
        ...
        eq_3 = MathTex("Z'", "=", r"\rho I", "+", r"\zeta R", "-", r"\alpha S Z", font_size=font_size)
